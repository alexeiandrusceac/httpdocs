...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <span> / </span>
            <li class="breadcrumb-item active" aria-current="page">{{trans('translate.litere')}}</li>
        </ol>
    </nav>

    <section class="info-litere">
                            ...
                            <li>
                                ...
                                <div class="services-nav">
                                    <ul>
                                        ...
                                        <li><a href="#" class="active">{{trans('translate.litere')}}</a></li>
                ...
                <div class="col-md-9 col-sm-12 col-xs-12 custom">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="imagine">
                                <img class="img-responsive"
                                     src="img/agency/services/litere/L-006.jpg" alt=""/>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <h3 class="text-center">{{trans('translate.infoTitle')}}</h3>
                            <p>{{trans('translate.literedesc')}}</p>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title text-center"
                                                id="litereModal">{{trans('translate.order')}}</h4>
                                        </div>
                    ...
                    <div class="row second-row">
                        <div class="col-md-10 col-sm-12 col-xs-12">
                            <div class="row">
                                @include("slideshows/litereimages")
                            </div>
                            <div class="row second-row">
                                <div class="wrapper-btn">
                                    <button data-toggle="modal" data-target="#orderModal"
