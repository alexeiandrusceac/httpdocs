...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <span> / </span>
            <li class="breadcrumb-item active" aria-current="page">{{trans('translate.pos')}}</li>
        </ol>
    </nav>
                            ...
                            <li>
                                <a href="#">
                                    ...
                                    <div class="services-nav">
                                        <ul>
                                            <li>
                                                <a href="{{url('','info_auto')}}">{{trans('translate.brandingauto')}}</a>
                                            </li>
                                            <li><a href="{{url('','info_casete')}}">{{trans('translate.reclame')}}</a>
                                            </li>
                                            ...
                                            <li><a href="{{url('','info_litere')}}">{{trans('translate.litere')}}</a>
                                            </li>
                                            <li>
                                                <a href="{{url('','info_suprafete')}}">{{trans('translate.suprPrelate')}}</a>
                                            </li>
                                            <li><a href="#" class="active">{{trans('translate.pos')}}</a></li>
                                        </ul>
                                    </div>
                                </a>
                            </li>
                ...
                <div class="col-md-9 col-sm-12 col-xs-12 custom">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="imagine">
                                <img class="img-responsive" src="img/agency/services/stand/S-013.jpg" alt=""/>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <h3 class="text-center">{{trans('translate.infoTitle')}}</h3>
                            <p>{{trans('translate.posdesc')}}</p>
