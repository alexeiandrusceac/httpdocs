...
@section('content')
    <section id="header-service-item" style="background-image: url('../img/agency/backgrounds/bg-mobile-fallback.jpg')">
        <div class="header-service">
            <h1>{{trans('translate.autocolant')}}</h1>
        </div>
    </section>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <span> / </span>
            <li class="breadcrumb-item active" aria-current="page">{{trans('translate.autocolant')}}</li>
        </ol>
    </nav>

    <section class="inf-autocolant">
                            ...
                            <li>
                                ...
                                <div class="services-nav">
                                    <ul>
                                        ...
                                        <li><a href="#" class="active">{{trans('translate.autocolant')}}</a></li>
                ...
                <div class="col-md-9 col-sm-12 col-xs-12 custom">
                    <div class="row">
                        <div class="col-md-5 col-sm-6 col-xs-12">
                            <div class="imagine">
                                <img class="img-responsive" src="img/agency/services/autocolant/AC-006.jpg" alt=""/>
                            </div>
                        </div>
                        <div class="col-md-5 col-sm-6 col-xs-12">
                            <h3 class="text-center">{{trans('translate.infoTitle')}}</h3>
                            <p class="info_par"><strong>{{trans('translate.printpolicro')}}</strong> {{trans('translate.printpolicrodesc')}}</p>
                            <p class="info_par"><strong>{{trans('translate.cutterploter')}}</strong> {{trans('translate.cutterploterdesc')}}</p>
                            <p class="info_par"><strong>{{trans('translate.perforat')}}</strong> {{trans('translate.perforatdesc')}}</p>
                            ...
                            <div class="modal" id="orderModal" tabindex="-1" role="dialog"
                                 aria-labelledby="autocolantModal">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title text-center"
                                                id="autocolantModal">{{trans('translate.order')}}</h4>
                                        </div>
                    ...
                    <div class="row second-row">
                        <div class="col-md-10 col-sm-12 col-xs-12">
                            <div class="row">
                                @include("slideshows/autocolimages")
                            </div>
                            <div class="row second-row">
                                <div class="wrapper-btn">
                                    <button data-toggle="modal" data-target="#orderModal"
