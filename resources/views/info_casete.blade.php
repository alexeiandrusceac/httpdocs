...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <span> / </span>
            <li class="breadcrumb-item active" aria-current="page">{{trans('translate.reclame')}}</li>
        </ol>
    </nav>

    <section class="info-casete">
                            ...
                            <li>
                                ...
                                <div class="services-nav">
                                    <ul>
                                        ...
                                        <li><a href="#" class="active">{{trans('translate.reclame')}}</a></li>
                ...
                <div class="col-md-9 col-sm-12 col-xs-12 custom">
                    <div class="row">
                        <div class="col-md-5 col-sm-6 col-xs-12">
                            <div class="imagine">
                                <img class="img-responsive" src="img/agency/services/casete_luminoase/CL-006.jpg"
                                     alt=""/>
                            </div>
                        </div>
                        <div class="col-md-5 col-sm-6 col-xs-12">
                            <h3 class="text-center">{{trans('translate.infoTitle')}}</h3>
                            <p class="info_par"><strong>{{trans('translate.caseteLumin')}} </strong> {{trans('translate.caseteLumindesc')}}</p>
                            <p class="info_par"><strong>{{trans('translate.litereLumin')}} </strong> {{trans('translate.litereLumindesc')}}</p>
                            <p class="info_par"><strong>{{trans('translate.totem')}} </strong> {{trans('translate.totemuridesc')}}</p>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title text-center"
                                                id="caseteModal">{{trans('translate.order')}}</h4>
                                        </div>
                    ...
                    <div class="row second-row">
                        <div class="col-md-10 col-sm-12 col-xs-12">
                            ...
                            <div class="row">
                                @include("slideshows/caseteimages")
                            </div>
